        ...
        <div className="flex flex-col lg:flex-row min-h-screen gap-12 lg:gap-16 py-20">
          ...
          <div className="w-full lg:w-1/2 lg:h-[75vh] lg:sticky lg:top-24 flex flex-col justify-between">
            ...
            <div className="mb-8 lg:mb-0">
              <span className="text-xs tracking-widest text-amber-800 uppercase font-semibold">What We Do</span>
              <h2 
                className="text-3xl md:text-5xl font-serif text-stone-950 tracking-tight mt-2"
                style={{ fontFamily: "'Playfair Display', 'Bodoni MT', serif" }}
              >
                Our Creations & <br />Masterclasses
              </h2>
              <p className="text-stone-600 font-light mt-4 max-w-md text-sm md:text-base">
            ...
            <div className="hidden lg:block w-full h-[45vh] rounded-xl overflow-hidden shadow-2xl relative bg-stone-200">
              <img 
          ...
          <div className="w-full lg:w-1/2 flex flex-col space-y-16 md:space-y-24">
            ...
            <div className="group border-b border-stone-200 pb-12">
              {/* Mobile Image Fallback */}
              <div className=" w-full h-64 rounded-xl overflow-hidden mb-6">
                <img src="https://images.unsplash.com/photo-1606983340126-99ab4feaa64a?q=80&w=1026&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Personal custom cakes" className="w-full h-full object-cover" />
              </div>
            ...
            <div className="group border-b border-stone-200 pb-12">
              {/* Mobile Image Fallback */}
              <div className=" w-full h-64 rounded-xl overflow-hidden mb-6">
                <img src="https://plus.unsplash.com/premium_photo-1675720060105-ba50ca9e21a7?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8dGllcmVkJTIwbHV4dXJ5JTIwd2VkZGluZyUyMGNha2V8ZW58MHx8MHx8fDA%3D" alt="Event gala cakes" className="w-full h-full object-cover" />
              </div>
              ...
              <h3 className="text-2xl md:text-3xl font-serif text-stone-900 mb-4">Cover Event Cake Needs</h3>
              <p className="text-stone-600 font-light leading-relaxed mb-6">
